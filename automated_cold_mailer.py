...
def send_gen_corders_offer(business_name, owner_email, niche, competitor_site):
    ...
    NOTE: This function ONLY sends the email. Logging is handled by the caller
    (global_lead_engine.py) to prevent double-logging."""
    ...
    # Recipient and Branding (Standard Text for Deliverability)
    from_name = f"Gen Coders <{SMTP_USER}>"
    subject_text = f"Audit Report: {business_name} - Why is your competitor closing more clients?"
    ...
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #444; border-top: 1px solid #0095f6; padding-top: 10px; margin-top: 20px; min-height: 100px;">
        ...
        <div style="float: left;">
            ...
            <strong style="color: #1a1a1a; font-size: 1.0em;">Gen Coders Pvt Ltd {blue_badge}</strong><br>
